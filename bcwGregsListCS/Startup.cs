...
public class Startup
{
  ...
  public void ConfigureServices(IServiceCollection services)
  {
    ...
    {
      c.SwaggerDoc("v1", new OpenApiInfo { Title = "bcwGregsListCS", Version = "v1" });
    });
    ...
    services.AddTransient<ClassifiedsService>();
    services.AddTransient<ClassifiedsRespository>();
  }
